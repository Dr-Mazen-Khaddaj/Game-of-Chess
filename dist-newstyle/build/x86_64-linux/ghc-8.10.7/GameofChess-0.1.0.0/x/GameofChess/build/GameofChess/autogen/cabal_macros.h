...
/* package GameofChess-0.1.0.0 */
#ifndef VERSION_GameofChess
#define VERSION_GameofChess "0.1.0.0"
#endif /* VERSION_GameofChess */
#ifndef MIN_VERSION_GameofChess
#define MIN_VERSION_GameofChess(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_GameofChess */
...
#define CURRENT_COMPONENT_ID "GameofChess-0.1.0.0-inplace-GameofChess"
